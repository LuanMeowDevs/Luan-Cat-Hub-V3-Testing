...
function vu102.RunModules(p585)
    ...
    local lf_169 = p585.Managers
        ...
        if v590 then
            ...
            vu32[v588] = nil
            warn("falha ao carregar Module [ Luan Cat hub ]: " .. v588 .. " : " .. v591)
        end
    end
end
...
function vu102.LoadLibrary(pu603)
    local lf_171 = vu81:MakeWindow({
        "Luan Cat V4 : Blox Fruits",
        "by Luan Cat And 1x1x1x1x1",
        "LuanCat-BloxFruits.json"
    })
